...
export default function RootLayout({children}:{children:React.ReactNode}){const measurementId=process.env.NEXT_PUBLIC_GA_MEASUREMENT_ID||"G-Y6C5JG2442";return <html lang="pt-BR"><body>{children}<GoogleAnalytics measurementId={measurementId}/></body></html>}
