...
export default function RootLayout({children}:{children:React.ReactNode}){const measurementId=process.env.NEXT_PUBLIC_GA_MEASUREMENT_ID||"G-Y6C5JG2442";const playStoreUrl=getPlayStoreUrl(process.env.NEXT_PUBLIC_PLAY_STORE_URL);return <html lang="pt-BR"><body>{children}<AppPromoBanner playStoreUrl={playStoreUrl}/><GoogleAnalytics measurementId={measurementId}/></body></html>}
