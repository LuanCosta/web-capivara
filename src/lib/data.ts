...
export type News = { id: string; title: string; summary: string; category: string; source: string; sourceUrl?:string; date: string; image?: string; content?: string; summaryAI?:string; politicians?: string[]; explain?:ExplainItem[] };
